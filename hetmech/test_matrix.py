...
def test_sparse_matrix():
    ...
    def inef_metaedge_to_adjacency_matrix(graph, metaedge, dtype=numpy.bool_):
        """
        ...
        # Inefficient but effective conversion
    ...
    mat_ineff = inef_metaedge_to_adjacency_matrix(graph, 'GiG')
